...
<html>
    ...
    <body>
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../formulario-productos/formulario-productos.jsp">Formulario de Productos</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container text-center">
            ...
            <ul>
                <% if (productos != null) { %>
                <p style="text-align: center" class="text-success display-5">Se agregó</p>
                <br>
        ...
        <div class="container mt-4">
            <form action="/SGBDProductosIN5CV/producto-servlet" method="post" enctype="multipart/form-data">
                <div class="form-floating mt-5">
                    <input class="form-control text-info-emphasis" id="nombreProducto" name="nombreProducto" type=text placeholder="">
                    <label for="nombreProducto">Nombre de Producto</label>
                </div>
                <div class="form-floating mt-4">
                    <textarea class="form-control text-info-emphasis" placeholder="" id="descripcionProducto" name="descripcionProducto"></textarea>
                    <label for="descripcionProducto">Descripcion del Producto</label>
                </div>
                <div class="form-floating mt-4">
                    <input class="form-control text-info-emphasis" id="marcaProducto" name="marcaProducto" type=text placeholder="">
